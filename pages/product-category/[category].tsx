...
import { getItemsFromCategory } from "../../components/Util/getters";
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  if (paramCategory !== "new-arrivals") {
    ...
    ;
    const numberOfProductsResponse = getItemsFromCategory(paramCategory)
    numberOfProducts = +numberOfProductsResponse.length;
  } else {
    numberOfProducts = 10;
  }
  ...
  return {
    props: {
      ...
      items: getItemsFromCategory(paramCategory),
      numberOfProducts,
      page: +page,
      orderby,
    },
