...
import { getLatest, getProductFromId } from "../../components/Util/getters";
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  const fetchedProduct = getProductFromId(+paramId);
  if (!fetchedProduct) {
    return {
      notFound: true,
    }}
  ...
  let product: itemType = {
    ...
    img1: fetchedProduct.img1,
    img2: fetchedProduct.img2,
    categoryName: fetchedProduct.categoryName,
  };


  let products: itemType[] = getLatest(5);
